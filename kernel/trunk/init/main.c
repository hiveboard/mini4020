...
{
        int i;
        *(unsigned int *)PMU_PCSR_V=0x1ffff;
        *(unsigned int *)PMU_PMDR_V=0x1;
        *(unsigned int *)PMU_PLTR_V=0x00d200cd;

        for(i=0;i<100;i++);

        *(unsigned int *)PMU_PMCR_V= PMCR;
        *(unsigned int *)PMU_PMCR_V= PMCR+0x8000;
}
