/**
 * @file	s1r72v27_udc.c
 * @brief	S1R72V27 USB Contoroller Driver(USB Device)
 * @date	2008/02/06
 * Modified for S1R72V27 from s1r72v18_udc.c
...
#define DRIVER_DESC     "S1R72V27 USB Device Controller driver"

#define S1R72_DEVICE_NAME	"s1r72v27"

#define	USBC_INIT	s1r72v27_usbc_module_init
#define	USBC_EXIT	s1r72v27_usbc_module_exit
...
module_init(s1r72v27_usbc_module_init);
module_exit(s1r72v27_usbc_module_exit);
