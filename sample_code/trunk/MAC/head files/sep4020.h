...
#define SMC0_TX                   (SMC0_BASE+0X010)       /* SMC0发送FIFO寄存器 */
#define SMC0_RX                   (SMC0_BASE+0X014)       /* SMC0接收FIFO寄存器 */
#define SMC0_INT_MASK             (SMC0_BASE+0X01C)       /* SMC0中断屏蔽寄存器 */
#define SMC0_STATUS		          (SMC0_BASE+0X020)       /* SMC0中断状态寄存器 */
#define SMC0_TX_TRIG              (SMC0_BASE+0X024)       /* SMC0传输TX_FIFO中的字节数 */
...
#define SMC1_TX                   (SMC1_BASE+0X010)       /* SMC1发送FIFO寄存器 */
#define SMC1_RX                   (SMC1_BASE+0X014)       /* SMC1接收FIFO寄存器 */
#define SMC1_INT_MASK             (SMC1_BASE+0X01C)       /* SMC1中断屏蔽寄存器 */
#define SMC1_STATUS		          (SMC1_BASE+0X020)       /* SMC1中断状态寄存器 */
#define SMC1_TX_TRIG              (SMC1_BASE+0X024)       /* SMC1传输TX_FIFO中的字节数 */
...
#define GPIO_PORTH_DIR            (GPIO_BASE+0X074)       /* H组端口输入输出方向配置寄存器 */
...
#define EMI_NAND_ID               (EMI_BASE+0X130)        /* NAND FLASH的ID寄存器 */
